...
<link rel = "stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/rentalInsert.css" />
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>BoxBox</title>
</head>
<body>
<div class="rentalInsert">
	<h2>대여정보 추가</h2>
...
<!-- 		<input type="text" id="itemModel" name="itemModel" placeholder="상품유형" autofocus
		...
		<input type="submit" class="btn btn-primary btn-block btn-large" value="대여정보 추가" /><br><br>
