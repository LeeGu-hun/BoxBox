...
<link rel = "stylesheet" type="text/css" href="<%=request.getContextPath()%>/css/rentalPlaceUpdate.css" />
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<title>BoxBox</title>
</head>
<body>
<div class="rentalPlaceUpdate">
	<h2>관리소 정보 변경</h2>
	<form method="post" action="">
		...
		<input type="text" id="place" name="place" placeholder="관리소 이름을 입력하세요." autofocus
			required="required" />
		<br><br>		
		<input type="submit" class="btn btn-primary btn-block btn-large" value="관리소 정보 변경"><br><br>
